                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center list-action">
                                        ...
                                        href="{{route('mail.show', ['mail' => $hehemail->id])}}"><i class="ri-eye-line mr-0"></i></a>
                                        <a class="badge bg-success mr-2 d-flex align-items-center justify-content-center" data-toggle="tooltip" data-placement="top"
                                            title="" data-original-title="Edit" href="{{ route('mail.edit', $hehemail)}}"><i
                                                class="ri-pencil-line mr-0"></i></a>
                                        <form action="{{ route('mail.destroy', $hehemail->id) }}" method="POST" class="d-flex align-items-center">
                                            @csrf
                                            @method('DELETE')
