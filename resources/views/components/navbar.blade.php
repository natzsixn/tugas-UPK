        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            <div class="iq-navbar-logo d-flex align-items-center justify-content-between">
                ...
                <a href="backend/index.html" class="header-logo">
                    <h3 class="logo-title ml-3">Kelompok Satu</h3>
                </a>
            </div>
                                ...
                                <div class="card shadow-none m-0">
                                    <div class="card-body p-0 text-center">
                                        <div class="media-body profile-detail text-center">
                                            <!-- Gambar latar belakang dan avatar -->
                                            <img src="{{asset('assets/images/page-img/profile-bg.jpg')}}" alt="profile-bg" class="rounded-top img-fluid mb-4">
                                            <img src="{{asset('assets/images/user/1.png')}}" alt="profile-img" class="rounded profile-img img-fluid avatar-70">
                                        </div>
                                        <div class="p-3">
                                            <!-- Informasi user -->
                                            <h5 class="mb-1">{{ Auth::user()->username }}</h5>
                                            <div class="d-flex align-items-center justify-content-center mt-3">
                                                <!-- Tautan ke halaman profil user -->
                                                <a href="{{ route('login') }}" class="btn border mr-2">Profile</a>
                                                <!-- Form logout -->
